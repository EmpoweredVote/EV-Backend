...
// zipPrefixToStateMap maps 3-digit ZIP code prefixes to state abbreviations.
// Based on USPS ZIP code allocation as of 2026.
var zipPrefixToStateMap = map[string]string{
	// Northeast
	...
	"340": "AA", "341": "FL",
	"342": "FL", "343": "FL", "344": "FL", "346": "FL", "347": "FL", "349": "FL",
	...
	"931": "CA", "932": "CA", "933": "CA", "934": "CA", "935": "CA", "936": "CA", "937": "CA", "938": "CA", "939": "CA",
...
// zipPrefixToState returns the state abbreviation for a given ZIP code.
// It uses the first 3 digits of the ZIP code to determine the state.
// Returns an empty string if the ZIP is invalid or not found.
func zipPrefixToState(zip string) string {
	// Ensure we have at least 3 digits
	if len(zip) < 3 {
		return ""
	}

	// Pad with leading zeros if needed (e.g., "501" -> "501", "50" -> "050")
	prefix := zip
	if len(prefix) < 3 {
		prefix = strings.Repeat("0", 3-len(prefix)) + prefix
	}
	...
	// Look up in map
	if state, ok := zipPrefixToStateMap[prefix]; ok {
		return state
	}
